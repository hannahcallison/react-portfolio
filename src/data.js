export const projects = [
  {
    title: "Found Ark",
    subtitle: "React, HTML, CSS, Node, Express, Socket.io, MySQL, JWT Tokens, Axios, Validator",
    description:
      "Found Ark is a web application that users can use to find and create groups for raids on the game Lost Ark. We make it easier for players to develop consistent game play groups and discover new ones to join without having to rely on a giant anonymous server where they may never get picked up.",
    image: "../assets/foundark.png",
    gitLink: "https://github.com/chuanw101/found-ark",
    deployLink: "https://found-ark.herokuapp.com/",
  },
  {
    title: "WikiLeeks",
